package org.alexdev.kepler.game.ig;

import org.alexdev.kepler.dao.mysql.IGDao;
import org.alexdev.kepler.game.player.Player;
import org.alexdev.kepler.game.player.PlayerDetails;
import org.alexdev.kepler.game.player.PlayerManager;
import org.alexdev.kepler.messages.outgoing.ig.FRIEND_REQUEST;
...
public class Messenger {
    ...
    public Messenger(PlayerDetails details) {
        ...
        this.friends = IGDao.getFriends(details.getId());
        this.requests = IGDao.getRequests(details.getId());
        this.offlineMessages = IGDao.getUnreadMessages(details.getId());
    ...
    public void addFriend(MessengerUser friend) {
        IGDao.removeRequest(friend.getUserId(), this.user.getUserId());
    ...
    public void addRequest(MessengerUser requester) {
        IGDao.newRequest(requester.getUserId(), this.user.getUserId());
    ...
    public void declineRequest(MessengerUser requester) {
        IGDao.removeRequest(requester.getUserId(), this.user.getUserId());
        this.requests.remove(requester.getUserId());
    }

    public void declineAllRequests() {
        IGDao.removeAllRequests(this.user.getUserId());
        this.requests.clear();
    }
    ...
    public boolean removeFriend(int userId) {
        ...
        IGDao.removeFriend(userId, this.user.getUserId());
        IGDao.removeFriend(this.user.getUserId(), userId);
